// Camellia Flowers CRM - Main JavaScript
...
// Restore orders view preference
document.addEventListener('DOMContentLoaded', function() {
...
// Modal functions for specific modals
...
// Initialize product preview listeners
document.addEventListener('DOMContentLoaded', function() {
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('Camellia Flowers CRM initialized');
