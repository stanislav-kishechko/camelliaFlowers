    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(default='Менеджер з продажу', max_length=100, verbose_name='Посада')),
                ('bio', models.TextField(blank=True, verbose_name='Про себе')),
                ('is_top_manager', models.BooleanField(default=False, verbose_name='Топ менеджер')),
